...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('admin_settings', function (Blueprint $table) {
            ...
            $table->string('coconut_key');
            $table->string('encoding_method')->default('ffmpeg');
            $table->boolean('allow_scheduled_posts')->default(false);
            ...
            $table->boolean('show_address_company_footer')->default(false);
            ...
            $table->boolean('allow_free_items_shop')->default(false);
            $table->boolean('allow_external_links_shop')->default(false);
            $table->boolean('users_can_delete_messages')->default(true);
            $table->boolean('delete_old_users_inactive')->default(false);
        });
    }
